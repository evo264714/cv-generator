...
const CreateCV = () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="my-8">
            ...
            <div className='mx-10'>
                <button type="submit" className="btn px-4 py-2 font-bold text-white bg-blue-500 rounded hover:bg-blue-700 m">Generate CV</button>
            </div>
        </form>
    );
};
